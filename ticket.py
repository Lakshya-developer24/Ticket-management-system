...
def Book():
    ...
    Button(top1, text='Confirm', bg='#00ff00', fg='black', font=('Arial', 17), width=9, command=lambda:BookNow()).grid(row=5, column=1, pady=10)
...
# defining buttons
Button(top, text='Book Ticket', font=('Arial', 14), fg='black', command=lambda:Book(), width=12, height=2, bg='Green').grid(row=1, column=0, padx=80, pady=20)

Button(top, text='View History', font=('Arial', 14), fg='black', command=lambda:ViewHistory(), width=12, height=2, bg='Green').grid(row=1, column=1, pady=20)

Button(top, text='Delete Booking', font=('Arial', 14), fg='black', command=lambda:DeleteBooking(), width=12, height=2, bg='Green').grid(row=2, column=0, pady=30)
